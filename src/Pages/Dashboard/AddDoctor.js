...
const AddDoctor = () => {
    ...
    const imgStorageKey = 'c140b47a720d471d4b83dc1708f565d2';
    ...
    return (
        <div>
            <h2 className="text-2xl text-secondary">Add a new Doctor</h2>
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="form-control w-full max-w-xs">
                    <label className="label">
                        <span className="label-text">Speacialization</span>
